...
import (
	...
	"github.com/ryo-n/cf-tool/client"
	"github.com/ryo-n/cf-tool/cmd"
	"github.com/ryo-n/cf-tool/config"
...
func main() {
	usage := `Codeforces Tool $%version%$ (cf). https://github.com/ryo-n/cf-tool
...
Examples:
  ...
  cf pull              Pull the latest codes of current problem into current
                       path.
  cf clone ryo-n      Clone all codes of ryo-n.
...
Script in template:
  ...
  $%path%$   Path to source file (Excluding $%full%$, e.g. "/home/ryo-n/")
